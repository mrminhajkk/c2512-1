...
// Find frequence of occurences for each temperature (use: map<float,int>) frequency 1 degree:1 times, 2 degree: 4 times, 3 degree:1 times, 4 degree:3 times, 5 degree:1 times
// Sort temperatures by frequency (use: multimap<float,int>)    sorted_frequency 1 times: 1 degree, 1 times : 3 degree, 1 times:5 degree, 3 times:4 degree, 4 times:2 degree
