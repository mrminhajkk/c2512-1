...
class BookingManager {
    private:
        // attributes
        //int booking_ids[MAX_BOOKINGS];      X
        //int ticket_amounts[MAX_BOOKINGS];   X
        //int food_amounts[MAX_BOOKINGS];     X
        Booking bookings[MAX_BOOKINGS];    //O
        int numBookings;
    public:
        // support
...
void BookingManager::deleteById() {
    ...
    for (int i = index; i < numBookings - 1; i++) {
        ...
        //bookings[i].id = bookings[i + 1].id;
        //bookings[i].ticketAmount = bookings[i + 1].ticketAmount;
        //bookings[i].foodAmount = bookings[i + 1].foodAmount;
